...
See [Python HowTo](./HOWTO_python.md).

### MANDATORY NEW SYSTEM INSTALLS STIG
...
[Unix Error Codes](http://www-numi.fnal.gov/offline_software/srt_public_context/WebDocs/Errors/unix_system_errors.html)
...
#Deleting a particular hard file to remove (especially Windows reserved words) this works...confirmed:
...
[Efficient Logging in Shell](http://www.cubicrace.com/2016/03/efficient-logging-mechnism-in-shell.html)

[Redirection](http://urbanautomaton.com/blog/2014/09/09/redirecting-bash-script-output-to-syslog/)
...
[Bash Variables](https://stackoverflow.com/questions/673055/correct-bash-and-shell-script-variable-capitalization/42290320#42290320)
...
Make script exit if an unsed variable is used:
...
[Linux History](https://www.thegeekstuff.com/2008/08/15-examples-to-master-linux-command-line-history/)
...
Reference: [SHELL Differences](http://hyperpolyglot.org/unix-shells#functions)

### SHELL TEMPLATE

1. [Template 1](https://www.uxora.com/unix/shell-script/18-shell-script-template)
2. [Template 2](http://teaching.idallen.com/cst8177/13w/notes/000_script_style.html)
3. [Template 3](https://natelandau.com/boilerplate-shell-script-template/)
...
[Globbing](https://www.linuxjournal.com/content/bash-extended-globbing)
...
See [Process Control](./HOWTO_unix_exeProcessControl.md)
