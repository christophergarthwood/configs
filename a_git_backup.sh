...
export GIT_AUTHOR_NAME="<some_user_name>";
export GIT_AUTHOR_EMAIL="${GIT_AUTHOR_EMAIL}@<some_domain>";
...
export the_git_user="<some_user_name>";
export the_git_repo="git@<some_url>:";
...
function set_vars() {
  ...
  then
    ...
    export PLATFORM_REMOTE_HOME=/u/yamm/${GIT_AUTHOR_NAME}
